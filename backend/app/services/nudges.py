...
# Qlass's own real, already-published marketing claims (qlasslearning.com)
# — reused verbatim/near-verbatim rather than invented, so nothing claimed
# here is a number Qlass hasn't actually stood behind publicly.

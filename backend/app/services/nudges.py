...
# No numeric outcome/scale claims here — only things the product itself
# verifiably does.
SOCIAL_PROOF_MESSAGES: list[str] = [
    "⏱️ Your Skoolgpt AI tutor is here 24×7 — no doubt has to wait until tomorrow.",
    "🗣️ You can talk to your Skoolgpt AI tutor in Hindi, Bhojpuri, and many other languages — voice-enabled, so language is never the thing standing between you and understanding.",
]

...
PROFILE_QUESTIONS: list[tuple[str, str]] = [
    ("class_", "By the way, which class are you in? That'll help me tailor my answers better. 📚"),
    ("board", "Also, which board are you studying under — CBSE, ICSE, or a State board?"),
